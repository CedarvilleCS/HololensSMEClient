...
namespace WPFColorPickerLib
{
    ...
    public partial class ColorPicker : UserControl
    {
        ...
        public ColorPicker(Color initialColor, Double initialSize)
        {
            InitializeComponent();
            this.selectedColor = initialColor;
            this.selectedSize = initialSize;
            this.txtBrushSize.Text = SelectedSize.ToString();
        }
        ...
        /// <summary>
        /// Gets or privately sets the Selected Size.
        /// </summary>
        public Double SelectedSize
        {
            ...
            private set
            {
                if (selectedSize != value)
                {
                    ...
                    {
                        txtBrushSize.Text = SelectedSize.ToString();
                    }
